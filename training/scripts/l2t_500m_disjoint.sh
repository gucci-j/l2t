...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-disjoint
output_dir="$SCRATCH/models/l2t-500m-disjoint"
dataset_dir="$SCRATCH/data/l2t_training_data_disjoint"
num_proc=$(( $(nproc) / 2 ))
