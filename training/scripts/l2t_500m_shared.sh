...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-shared
output_dir="$SCRATCH/models/l2t-500m-shared"
dataset_dir="$SCRATCH/data/l2t_training_data_shared"
num_proc=$(( $(nproc) / 2 ))
