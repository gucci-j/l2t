...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-mix_25
output_dir="$SCRATCH/models/l2t-500m-mix_25"
dataset_dir="$SCRATCH/data/l2t_training_data_mix_25"
num_proc=$(( $(nproc) / 2 ))
