...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-mix_75
output_dir="$SCRATCH/models/l2t-500m-mix_75"
dataset_dir="$SCRATCH/data/l2t_training_data_mix_75"
num_proc=$(( $(nproc) / 2 ))
