...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-shuffle
output_dir="$SCRATCH/models/l2t-500m-shuffle"
dataset_dir="$SCRATCH/data/l2t_shuffle_training_data"
