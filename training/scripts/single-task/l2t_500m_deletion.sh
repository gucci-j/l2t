...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-deletion
output_dir="$SCRATCH/models/l2t-500m-deletion"
dataset_dir="$SCRATCH/data/l2t_deletion_training_data"
