...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-char_count
output_dir="$SCRATCH/models/l2t-500m-char_count"
dataset_dir="$SCRATCH/data/l2t_char_count_training_data"
