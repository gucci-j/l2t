...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-masked_word
output_dir="$SCRATCH/models/l2t-500m-masked_word"
dataset_dir="$SCRATCH/data/l2t_masked_word_training_data"
