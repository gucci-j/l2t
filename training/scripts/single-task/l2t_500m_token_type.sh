...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-token_type
output_dir="$SCRATCH/models/l2t-500m-token_type"
dataset_dir="$SCRATCH/data/l2t_token_type_training_data"
