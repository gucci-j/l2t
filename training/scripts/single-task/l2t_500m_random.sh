...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-random
output_dir="$SCRATCH/models/l2t-500m-random"
dataset_dir="$SCRATCH/data/l2t_random_training_data"
