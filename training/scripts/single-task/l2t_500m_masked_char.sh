...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-masked_char
output_dir="$SCRATCH/models/l2t-500m-masked_char"
dataset_dir="$SCRATCH/data/l2t_masked_char_training_data"
