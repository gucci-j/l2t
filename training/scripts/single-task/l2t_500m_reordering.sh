...
log_dir=/path/to/l2t/repository/training/logs/l2t-500m-reordering
output_dir="$SCRATCH/models/l2t-500m-reordering"
dataset_dir="$SCRATCH/data/l2t_reordering_training_data"
